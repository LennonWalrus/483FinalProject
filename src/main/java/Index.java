...
public class Index {
    ...
    //method to build the lucene index does so by looping though wiki text files and designating and filling wiki pages using stemming
            ...
            try (
                ...
                while (inputScanner.hasNextLine()) {//while there is still more to the file
                    ...
                    if (line[0].startsWith("[[") && !line[0].startsWith("[[File:") && !line[0].startsWith("[[file:") && !line[0].startsWith("[[Image:") && !line[0].startsWith("[[image:")) {
                        ...
                        String content = "";// to save stemmed content of page
